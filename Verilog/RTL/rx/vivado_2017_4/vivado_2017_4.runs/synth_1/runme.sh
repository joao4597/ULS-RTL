...
HD_PWD='/home/joao/Documents/ULS-RTL/Verilog/RTL/rx/vivado_2017_4/vivado_2017_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_samples_organizer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rx_samples_organizer.tcl
